...
static const char qt_meta_stringdata_GLtree[] = {
    "GLtree\0\0timeOutSlot()\0"
};
...
const QMetaObjectExtraData GLtree::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GLtree::staticMetaObject = {
    { &WinGL::staticMetaObject, qt_meta_stringdata_GLtree,
      qt_meta_data_GLtree, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GLtree::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GLtree))
        return static_cast<void*>(const_cast< GLtree*>(this));
